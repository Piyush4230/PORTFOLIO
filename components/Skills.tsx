...
<p className="text-gray-400 text-lg max-w-3xl mb-12">
  My technical skill set includes modern programming languages, frontend and backend frameworks, databases, and development tools that I use to build scalable and user-friendly applications.
</p>
